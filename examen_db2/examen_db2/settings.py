"""
Django settings for examen_db2 project.
...
SECRET_KEY = 'django-insecure-gn%3iwlz!eqs5a_ralq+$mn5dt@o%zmq-1ep2_4efje5=aenrg'
...
INSTALLED_APPS = [
    ...
    'misapps.clients.apps.ClientsConfig',
    'misapps.reservations.apps.ReservationsConfig',
...
WSGI_APPLICATION = 'examen_db2.wsgi.application'
